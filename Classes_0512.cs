namespace Tech
{
    ...
    public enum Name { AdvancedLogisticSciencePack, AlienSciencePack, AlienSciencePackBlue, AlienSciencePackGreen, AlienSciencePackOrange, AlienSciencePackPurple, AlienSciencePackRed, AlienSciencePackYellow, AutomationSciencePack, ChemicalSciencePack, LogisticSciencePack, MilitarySciencePack, ProductionSciencePack, SbAlgaeBrownTool, SbAngelsore3Tool, SbBasicCircuitBoardTool, SbLabTool, SciencePackGold, SctBioSciencePack, SpaceSciencePack, UtilitySciencePack };
    ...
    internal class NameConverter : JsonConverter
    {
        ...
        public override object ReadJson(JsonReader reader, Type t, object existingValue, JsonSerializer serializer)
        {
            ...
            switch (value)
            {
                ...
                case "sb-algae-brown-tool":
                    return Name.SbAlgaeBrownTool;
        ...
        public override void WriteJson(JsonWriter writer, object untypedValue, JsonSerializer serializer)
        {
            ...
            switch (value)
            {
                ...
                case Name.ProductionSciencePack:
                    ...
                    return;
                case Name.SbAlgaeBrownTool:
                    serializer.Serialize(writer, "sb-algae-brown-tool");
                    return;
